            ...
            <form action="{{route('register-process')}}" method="post">
              ...
              <div class="row">
                <div class="col-12 form-group">
                    <input type="name"   contenteditable="true" spellcheck="true" class="form-control" name="fullname" placeholder="Full Name" />
                    <i class="fa fa-user"></i> </div>
                    <div class="col-12 form-group">
                      <input type="name"   contenteditable="true" spellcheck="true" class="form-control" name="lastname" placeholder="Last Name" />
                      <i class="fa fa-user"></i> </div>
                <div class="col-12 form-group">
                  <input type="email" contenteditable="true" spellcheck="true" class="form-control" name="email" placeholder="Email Address" />
                  <i class="fa fa-envelope"></i> </div>
                  <div class="col-12 form-group">
                    <input type="number" contenteditable="true" spellcheck="true" class="form-control" name="phone_number" placeholder="Phone Number" />
              ...
              <div class="new-user forget-pass"> <a href="{{route('view-login')}}" class="login form-control"><i class="fa fa-arrow-circle-left"></i>Have Already an Account? Login Here </a></div>
            </form>
          </div>
        </div>
      </div>
